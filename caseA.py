...
FEELING, DOMANDELUNGHE, DOMANDECORTE, DOMANDELUNGHE2, DOMANDELUNGHE3, RACCOMANDAZIONE, RATINGS = range(7)
stato = None
...
def ratings(update: Update, context: CallbackContext) -> int:
    ...
    if rateUser == '1️⃣':
        lineaDaInserire = 'CASO A - 1 stella'
    elif rateUser =='2️⃣':
        lineaDaInserire = 'CASO A - 2 stelle'
    elif rateUser =='3️⃣':
        lineaDaInserire = 'CASO A - 3 stelle'
    elif rateUser =='4️⃣':
        lineaDaInserire = 'CASO A - 4 stelle'
    elif rateUser =='5️⃣':
        lineaDaInserire = 'CASO A - 5 stelle'
...
def main() -> None:
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            FEELING: [MessageHandler(Filters.regex('^(Happy 😁|Neutral 😐|Sad ☹️|Angry 😡)$'), statoAnimo),CommandHandler('somethingelse', mostraAltro)], 
